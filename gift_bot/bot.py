...
# ----------------- ИЗРЕЧЕНИЯ -----------------
quotes = [
    ("Любовь — это не чувство, а решение заботиться каждый день.", "Эрих Фромм"),
    ("Уважение — это форма любви, которая не требует доказательств.", "Эрих Фромм"),
    ("Счастливая семья строится не на идеальности, а на принятии.", "Михаил Лабковский"),
    ("Мужчине важно чувствовать, что он нужен, а не просто полезен.", "Семейная психология"),
    ("Близость начинается там, где заканчиваются упрёки.", "Джон Готтман"),
    ("Любовь — это когда выбирают снова, даже после трудного дня.", "Психология отношений"),
    ("Сильные отношения — это диалог, а не борьба.", "Карл Роджерс"),
    ("Настоящее уважение не требует контроля.", "Карл Юнг"),
    ("Мужчине важно быть услышанным, даже когда он молчит.", "Семейная терапия"),
    ("Семья — это место, где можно быть собой без страха.", "Вирджиния Сатир"),
    ("Любовь — это забота без условий.", "Эрих Фромм"),
    ("Отношения живы, пока в них есть внимание.", "Джон Готтман"),
    ("Мужчине нужна вера в него, а не сомнения.", "Психология семьи"),
    ("Уважение укрепляет любовь сильнее страсти.", "Семейная психология"),
    ("Счастье в браке — это навык, а не удача.", "Михаил Лабковский"),
    ("Любовь — это быть рядом, а не быть правым.", "Психология отношений"),
    ("Тепло важнее правильности.", "Вирджиния Сатир"),
    ("Мужчина расцветает там, где его ценят.", "Семейная терапия"),
    ("Семья держится на доброте в мелочах.", "Карл Роджерс"),
    ("Любовь — это безопасное пространство для двоих.", "Психология отношений"),

    # --- ДОБАВЛЕННЫЕ ИЗРЕЧЕНИЯ ПРО МАМУ ---
    ("Ты невероятная мама, и без тебя этот дом был бы другим.", "Семейная психология"),
    ("Ты — сердце этого дома.", "Вирджиния Сатир"),
    ("Ты делаешь семью семьёй.", "Психология семьи"),
    ("Ты та, на ком держится уют.", "Семейная терапия"),
    ("Ты мама, без которой здесь ничего не работало бы.", "Психология отношений"),
    ("Ты сильнее, чем думаешь.", "Семейная психология"),
    ("Ты создаёшь атмосферу любви.", "Вирджиния Сатир"),
    ("Ты незаменима.", "Семейная терапия"),
    ("Ты фундамент этой семьи.", "Психология семьи"),
    ("Ты та, благодаря кому здесь тепло.", "Семейная психология"),
    ("Ты — пример заботы.", "Психология отношений"),
    ("Ты мама, которой можно гордиться.", "Семейная терапия"),
    ("Ты делаешь невозможное каждый день.", "Психология семьи"),
    ("Ты та, без кого нельзя.", "Семейная психология"),
    ("Ты — тихая сила семьи.", "Вирджиния Сатир"),
    ("Ты важнее всех дел.", "Семейная терапия"),
    ("Ты источник любви.", "Психология отношений"),
    ("Ты создаёшь дом.", "Семейная психология"),
    ("Ты та, кто держит всё вместе.", "Психология семьи"),
    ("Ты мама — и этим всё сказано.", "Семейная терапия"),
]
